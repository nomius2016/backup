    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/admin/admins/welcome" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-right">&copy; 2014-2015 <a href="/static/hplus/http://www.zi-han.net/" target="_blank">zihan's blog</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
        ...
        <div id="right-sidebar">
            <div class="sidebar-container">
                ...
                <ul class="nav nav-tabs navs-3">
                    ...
                    <li><a data-toggle="tab" href="/static/hplus/#tab-3">
                        项目进度
                    </a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane active">
                        ...
                        固定宽度
                         ...
                         <a href="/static/hplus/#" class="s-skin-0">
                             默认皮肤
                         </a>
                    </span>
                            </div>
                            <div class="setings-item blue-skin nb">
                                <span class="skin-name ">
                        <a href="/static/hplus/#" class="s-skin-1">
                            蓝色主题
                        </a>
                    </span>
                            </div>
                            <div class="setings-item yellow-skin nb">
                                <span class="skin-name ">
                        <a href="/static/hplus/#" class="s-skin-3">
                            黄色/紫色主题
                        </a>
                    </span>
                            </div>
